...
#define PACKAGE_BUGREPORT "valgrind-users@lists.sourceforge.net; valgrind@packages.debian.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Valgrind"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Valgrind 3.8.1-Debian"
...
#define PACKAGE_VERSION "3.8.1-Debian"
